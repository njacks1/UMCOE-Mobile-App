...
/// [EventsExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class EventsExpansionTile extends StatefulWidget {
  ...
  @override
  _EventsExpansionTileState createState() => _EventsExpansionTileState();
}

class _EventsExpansionTileState extends State<EventsExpansionTile> with SingleTickerProviderStateMixin {
